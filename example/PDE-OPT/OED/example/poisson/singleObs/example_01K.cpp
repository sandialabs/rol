...
#include "../src/pde_poissonK.hpp"
#include "../src/obj_poissonK.hpp"
#include "../src/noise.hpp"
#include "../src/meshK.hpp"
...
//  feenableexcept(FE_DIVBYZERO | FE_INVALID | FE_OVERFLOW);
  ...
  try {
    ...
    auto meshMgr = ROL::makePtr<MeshManager_OED_Poisson<RealT,DeviceT>>(*parlist);
    auto pde = ROL::makePtr<PDE_OED_Poisson<RealT,DeviceT>>(*parlist);
    ...
    auto zp = ROL::makePtr<ROL::StdVector<RealT>>(numSides);

    // Create observation function
    auto qoi = ROL::makePtr<QoI_Poisson_Observation<RealT,DeviceT>>(pde->getFE(),*parlist);
    ...
    *outStream << "End: PDE Solves" << std::endl << std::endl;
    ...
    auto theta = ROL::makePtr<ROL::StdVector<RealT>>(numSides,1);
    ...
    auto dsampler = ROL::makePtr<ROL::MonteCarloGenerator<RealT>>(nsampd,bounds,dbman,false,false,0,1);
    auto osampler = ROL::makePtr<ROL::MonteCarloGenerator<RealT>>(nsampo,bounds,obman,false,false,0,nsampd+1);
    ...
    auto noise   = ROL::makePtr<Poisson_Noise<RealT>>();
