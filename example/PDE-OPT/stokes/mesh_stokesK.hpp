...
class MeshManager_Stokes : public MeshManager_Rectangle<Real,DeviceType> {
private:
  int nx_;
  int ny_;
...
public:
  ...
  MeshManager_Stokes(ROL::ParameterList &parlist) : MeshManager_Rectangle<Real,DeviceType>(parlist) {
