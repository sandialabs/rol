...
/*! \file  example_01.cpp
    \brief Shows how to solve a semilinear problem.
*/
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    auto pde = ROL::makePtr<PDE_Semilinear<RealT, DeviceT>>(*parlist);
    ...
    qoi_vec[0] = ROL::makePtr<QoI_L2Tracking_Semilinear<RealT, DeviceT>>(pde->getFE());
    qoi_vec[1] = ROL::makePtr<QoI_L2Penalty_Semilinear<RealT, DeviceT>>(pde->getFE());
    auto std_obj = ROL::makePtr<StdObjective_Semilinear<RealT>>(*parlist);
    ...
    ROL::Ptr<ROL::Vector<RealT>> b = x->clone();
    b->zero();
