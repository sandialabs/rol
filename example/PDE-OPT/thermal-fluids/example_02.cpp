...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    ROL::Ptr<PDE_ThermalFluids<RealT> > pde
      = ROL::makePtr<PDE_ThermalFluids<RealT>>(*parlist);
    ...
    ROL::Ptr<Tpetra::MultiVector<> > u_ptr, p_ptr, du_ptr, yu_ptr, yp_ptr, r_ptr, z_ptr, dz_ptr;
    ...
    ROL::Ptr<ROL::Vector<RealT> > up, pp, dup, yup, ypp, rp, zp, dzp;
