...
public:
  ...
  MeshManager_BackwardFacingStepChannel(ROL::ParameterList &parlist) {
    // Geometry data.
...
public:
  ...
  MeshManager_Rectangle(ROL::ParameterList &parlist) {
    // Geometry data.
...
public:
  ...
  MeshManager_Interval(ROL::ParameterList &parlist) {
...
public:
  ...
  MeshManager_Fractional_Cylinder(ROL::ParameterList &parlist) : X0_(0) {
    // Mesh data
...
public:
  ...
  MeshManager_Brick(ROL::ParameterList &parlist) {
    // Geometry data.
    width_  = parlist.sublist("Geometry").get( "Width", 3.0);
